  ...
  useEffect(() => {
    const fetchMyEvents = async () => {
      try {
        ...
        const data = await organizerServices.getMyEvents(
          currentPage,
          EVENTS_PER_PAGE
        );
      ...
      <div className="min-h-[calc(100vh-72px)] bg-gradient-to-br from-blue-50 via-white to-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-10">
            ...
            <span className="px-4 py-2 bg-blue-100 text-blue-700 rounded-full font-semibold w-fit">
              {totalEvents} Events
            </span>
          </div>
          ...
          {events.length === 0 ? (
            <div className="bg-white rounded-2xl shadow-md p-12 text-center">
              ...
              <p className="text-gray-500 mt-3">
                You haven't created any events. Create your first
                campus event to get started.
              </p>
            </div>
          ) : (
            <>
